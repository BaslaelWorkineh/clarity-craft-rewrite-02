...
const FEATURES = [
	{
		...
		description:
			"Transform your messages directly in Gmail, Slack, LinkedIn, and other platforms with our browser plugin.",
		icon: <Smartphone className="w-6 h-6" />,
	},
	{
		title: "Tone Templates",
		description:
			"Access pre-made templates for common situations like asking for a raise or rejecting a meeting.",
		icon: <ScrollText className="w-6 h-6" />,
	},
	{
		title: "AI Memory",
		description:
			"Our AI learns your preferred tones over time and suggests rewrites automatically.",
		icon: <Brain className="w-6 h-6" />,
	},
	{
		title: "Tone Analytics",
		description:
			"Get insights into your communication patterns with weekly reports on your messaging style.",
...
export default function Features() {
	return (
		<section
			id="features"
			className="py-24 px-6 bg-gradient-to-b from-background to-clarity-dark-purple/30 relative overflow-hidden"
		>
							...
							<Card className="premium-card rounded-none sharp-border border-plus-pattern hover:border-clarity-purple/30 transition-all duration-300 hover:transform hover:-translate-y-1 overflow-hidden bg-black">
								<CardContent className="p-8">
									<div className="w-12 h-12 rounded-none sharp-border bg-clarity-purple/20 flex items-center justify-center mb-4">
										<span className="text-clarity-purple">
											{feature.icon}
										</span>
									</div>
									...
									<button
										className="text-clarity-purple flex items-center text-sm font-medium group"
